...
Finally I found an <a href="https://stackoverflow.com/a/44692935" target="_blank"> answer </a> on StackOverflow that didn't quite work, but send me in the right direction. Eventually I gave up the DuckDuckGoing and did what I should have done in the first place: Look at the <a href="https://git-scm.com/docs/git-submodule" target="_blank"> Git documentation </a> for the submodule command.
